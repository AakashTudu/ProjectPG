package com.example.hostel.FilterableAdapter;
...
public abstract class FirebaseRecyclerFilterableAdapter<T, VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> implements FirebaseAdapter<T>, Filterable {
    private static final String TAG = "FirebaseRecyclerFilterableAdapter";
     ...
     */
    public FirebaseRecyclerFilterableAdapter(FirebaseRecyclerOptions<T> options, boolean isFiltarable) {
    ...
    public void onError(DatabaseError error) {
        Log.w("sdfsdfsd", error.toException());
    }
