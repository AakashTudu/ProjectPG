...
class MonthYearPickerDialog private constructor(
    ...
    init {
        monthYearPickerView.context.withStyledAttributes(themeResId, com.example.monthandyearpicker.R.styleable.MonthYearPickerDialog) {
            val backgroundColor = getColor(com.example.monthandyearpicker.R.styleable.MonthYearPickerDialog_monthBackgroundColorSelected, android.R.attr.colorBackgroundFloating)
